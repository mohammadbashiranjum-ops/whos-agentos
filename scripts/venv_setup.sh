...
# Quotes matter twice here: a clone path with a space, and `[dev]` — unquoted, bash
# reads it as a glob character class and silently rewrites the path when a sibling
